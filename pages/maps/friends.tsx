    ...
    useEffect(() => {
        ...
        maps.features.forEach((feature) => {
            ...
            feature.geometry.coordinates.forEach((arr1) => {
                ...
                KakaoMapSingleton.maps.event.addListener(polygon, 'mouseover', function (mouseEvent) {
                ...
                KakaoMapSingleton.maps.event.addListener(polygon, 'mouseout', function () {
        ...
        return () => { polygons.forEach(polygon => polygon.setMap(null)); customOverlay.setMap(null) };
    }, [map]);
